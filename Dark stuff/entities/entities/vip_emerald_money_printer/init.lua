...
function ENT:Use(activator)
	...
	GAMEMODE:Notify(activator, 1, 4, "You have collected $"..self:GetNWInt("PrintA").." from a VIP Emerald Printer.")
	self:SetNWInt("PrintA",0)
	end
end
...
function ENT:CreateMoneybag()
	...
	local Y = roundNum(GAMEMODE.Config.emeraldprintamount * 1.5, 0)
	if amount == 0 then
		amount = 25
	end
