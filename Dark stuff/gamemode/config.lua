...
GM.Config.DisallowDrop = {
	...
	["pocket"] = true,
        ...
        ["weapon_physgun"] = true,
        ["weapon_jihadbomb"] = true,
        ["spiderman's_swep"] = true,
        ["climb_swep2"] = true,
        ["arrest_stick"] = true,
        ["weapon_mad_fists"] = true
}
...
GM.Config.amethystprintamount                   = 25
GM.Config.emeraldprintamount                    = 55
GM.Config.rubyprintamount                               = 125
GM.Config.sapphireprintamount                   = 155
GM.Config.rdprintamount                         = 215
GM.Config.ydprintamount                         = 415
GM.Config.godprintamount                         = 825
GM.Config.melonprintamount                      = 10000