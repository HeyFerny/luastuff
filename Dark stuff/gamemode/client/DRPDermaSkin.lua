...
local function ChangeJobVGUI()
	if not F4Menu or not F4Menu:IsValid() then
		...
		F4Tabs = {GAMEMODE:MoneyTab(), GAMEMODE:JobsTab(), GAMEMODE:EntitiesTab(), GAMEMODE:RPHUDTab(), GAMEMODE:VIPJobs(), GAMEMODE:AdminJobs(), GAMEMODE:LyraJobs()}
	...
	if not F4MenuTabs or not F4MenuTabs:IsValid() then
		...
		F4MenuTabs:AddSheet("Shop", F4Tabs[3], "icon16/cart.png", false, false)
		F4MenuTabs:AddSheet("HUD", F4Tabs[4], "icon16/camera.png", false, false) -- Depricated on test server
		F4MenuTabs:AddSheet("VIP Jobs", F4Tabs[5], "icon16/user_green.png", false, false)
		--if LocalPlayer():IsUserGroup("admin") or LocalPlayer():IsUserGroup("superadmin") then
			F4MenuTabs:AddSheet("Admin Jobs", F4Tabs[6], "icon16/user_orange.png", false, false)
		--end
		--if LocalPlayer():IsUserGroup("superadmin") then
			F4MenuTabs:AddSheet("Test", F4Tabs[7], "icon16/user_red.png", false, false)
		--end
	end
